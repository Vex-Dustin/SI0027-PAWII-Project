...
let mahasiswa = [
  ...
  { id: 3, nama: "Dewi", jurusan: "Sistem Informasi", status: 'Aktif'},
  { id: 4, nama: "Tipen", jurusan: "Informatika", status: 'Cuti'},
];
...
app.post("/mahasiswa", (req, res) => {
  ...
  const baru = {
    id: mahasiswa.length+1, nama, jurusan,
  };
